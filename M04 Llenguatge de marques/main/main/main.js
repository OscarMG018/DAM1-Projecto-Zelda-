...
function initGUI() {
    ...
    pointFolder.add(pointLight, 'radius', 0, window.innerWidth).name('radius');
    pointFolder.add(pointLight, 'z', 0, window.innerWidth).name('distance');
...
texture_img.src = 'img/totk-material-1_basecolor (1).webp';
texture_normal_img.crossOrigin = "Anonymous";
texture_normal_img.onload = imageLoadedHandler;
texture_normal_img.src = 'img/totk-material-1_normal (1).webp';